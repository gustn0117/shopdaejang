  ...
  return (
    ...
    >
      ...
      <div className="p-3">
        ...
        <h3 className="font-bold text-sm line-clamp-1 mb-2 text-foreground group-hover:text-foreground/70">
          {listing.title}
        </h3>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <h3 className="font-bold text-sm lg:text-base line-clamp-1 mb-1 group-hover:text-foreground/70">
          {listing.title}
        </h3>
...
export function NormalRow({ listing }: { listing: Listing }) {
  return (
    <Link
      href={`/listings/${listing.id}`}
      className="group flex items-center gap-3 px-3 py-3 bg-white border-b border-border last:border-0 hover:bg-zinc-50"
    >
      ...
      <h3 className="flex-1 text-sm font-medium line-clamp-1 group-hover:text-foreground/70">
        {listing.title}
      </h3>
...
export function FreeRow({ listing }: { listing: Listing }) {
  return (
    <Link
      href={`/listings/${listing.id}`}
      className="group flex items-center gap-2 px-3 py-2.5 bg-white border-b border-border last:border-0 hover:bg-zinc-50"
    >
      ...
      <h3 className="flex-1 text-xs lg:text-sm line-clamp-1 group-hover:text-foreground/70">
        {listing.title}
      </h3>
