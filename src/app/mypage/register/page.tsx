...
export const metadata = {
  title: "매물등록",
  description: "마사지샵 매물을 직접 등록하세요. 등록 후 매물관리에서 광고 상품을 구매할 수 있습니다.",
};
    ...
    <div className="container-custom py-4 lg:py-8">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted">
          매물을 등록하면 무료 10일간 노출됩니다. 유료 광고는 등록 후 매물관리에서 구매하실 수 있습니다.
        </p>
      </div>
      ...
      <div className="max-w-3xl mx-auto">
        <RegisterForm categories={CATEGORIES} regions={REGIONS} />
      </div>
    </div>
  );
}
