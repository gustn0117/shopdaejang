    ...
    <div className="container-custom py-8 lg:py-16 max-w-md">
      <div className="text-center mb-6">
        <Link href="/" className="inline-flex items-center gap-2 mb-4">
          <span className="w-12 h-12 rounded-xl bg-primary text-white font-black text-2xl flex items-center justify-center">샵</span>
      ...
      <div className="bg-white rounded-2xl border border-border p-5 space-y-2">
        <button className="flex items-center justify-center gap-3 w-full py-3.5 bg-[#03C75A] text-white font-bold rounded-lg hover:opacity-95">
          <span className="w-5 h-5 bg-white text-[#03C75A] rounded-sm flex items-center justify-center font-black text-xs">N</span>
          네이버로 시작하기
        </button>
        <button className="flex items-center justify-center gap-3 w-full py-3.5 bg-[#FEE500] text-black font-bold rounded-lg hover:opacity-95">
          <span>💬</span>
          카카오로 시작하기
        </button>
        <button className="flex items-center justify-center gap-3 w-full py-3.5 bg-white border border-border text-foreground font-bold rounded-lg hover:bg-zinc-50">
        ...
        <form className="space-y-2">
          ...
          <button
            type="submit"
            className="w-full py-3 bg-foreground text-white font-bold rounded-lg hover:opacity-90"
          >
            이메일로 로그인
          </button>
        </form>
        ...
        <div className="flex items-center justify-between text-xs text-muted pt-2">
          <Link href="/signup" className="hover:text-primary">이메일 회원가입</Link>
          <span>|</span>
          <Link href="/find-account" className="hover:text-primary">아이디·비밀번호 찾기</Link>
        </div>
      </div>
