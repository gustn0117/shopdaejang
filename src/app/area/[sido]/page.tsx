    ...
    <div className="container-custom py-4 lg:py-6">
      ...
      <header className="mb-4">
        ...
        <p className="text-xs lg:text-sm text-muted mt-2">
          {sido} 지역에 등록된 마사지샵 양도양수 매물 <span className="text-primary font-bold">{listings.length}건</span>을 한눈에 확인하세요.
        </p>
      </header>
        ...
        <div className="grid grid-cols-3 sm:grid-cols-6 gap-2">
          {catCounts.map((c) => (
            <Link
              ...
              className="px-2 py-2 text-xs text-center border border-border rounded hover:border-primary hover:text-primary hover:bg-primary-light"
            >
